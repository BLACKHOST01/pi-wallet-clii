...
function makePayment() {
    ...
    const accountPassphrase =(config.account_Passphrase) ? config.account_Passphrase : prompt(chalk.yellowBright('Source Account Passphrase/PrivateKey: '));
    //get destination account information
    const destAccountAddress = (config.dest_AccountAdress) ? config.dest_AccountAdress : prompt(chalk.yellowBright('Destination Account Address: '));
